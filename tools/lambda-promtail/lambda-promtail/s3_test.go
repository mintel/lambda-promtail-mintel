...
func Test_parseS3Log(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedLen:    1,
			expectedStream: `{__aws_log_type="s3_lb", __aws_s3_lb="source", __aws_s3_lb_owner="123456789012", lb_account_id="123456789012", lb_aws_region="us-east-1", lb_name="source"}`,
			expectedTimestamps: []time.Time{
		...
		},
		{
			...
			expectedLen:    1,
			expectedStream: `{__aws_log_type="s3_lb", __aws_s3_lb="source", __aws_s3_lb_owner="671290407336", lb_account_id="671290407336", lb_aws_region="us-east-2", lb_name="source"}`,
			expectedTimestamps: []time.Time{
